...
/**
 * China market topic taxonomy only. This file intentionally contains no
 * province registry, policy conclusion, tariff, amount, ratio, or assumption.
 * Province identity must come from the regions table at runtime.
 */
