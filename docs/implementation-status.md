...
| 公开看板 | 完成 | 首页六大洲目录；大洲递归范围；地区、搜索、详情与原文链接；中国31省×7专题前端矩阵 | 专题真实值与字段级来源尚未接入 |
| Admin | 完成 | 未登录重定向/API 401；真实 Supabase Admin Auth；CRUD/发布 API E2E | 单管理员角色，无复杂 RBAC |
...
|---|---|---|---|---|---|---|
| 省级电力市场交易规则 | Taxonomy 完成；字段存储待建 | 未接入 | 复用公开地区；专题 API 待建 | 完成空态矩阵 | Taxonomy/31省测试 | 未接入 |
| 省级储能容量补偿/容量电价 | Taxonomy 完成；字段存储待建 | 未接入 | 复用公开地区；专题 API 待建 | 完成空态矩阵 | Taxonomy/31省测试 | 未接入 |
| 省级辅助服务品种与金额 | Taxonomy 完成；字段存储待建 | 未接入 | 复用公开地区；专题 API 待建 | 完成空态矩阵 | Taxonomy/31省测试 | 未接入 |
| 第四监管周期价表与线损率 | Taxonomy 完成；字段存储待建 | 未接入 | 复用公开地区；专题 API 待建 | 完成空态矩阵 | Taxonomy/31省测试 | 未接入 |
| 省级储能系统运行费用 | Taxonomy 完成；字段存储待建 | 未接入 | 复用公开地区；专题 API 待建 | 完成空态矩阵 | Taxonomy/31省测试 | 未接入 |
| 省级绿电直连政策 | Taxonomy 完成；字段存储待建 | 未接入 | 复用公开地区；专题 API 待建 | 完成空态矩阵 | Taxonomy/31省测试 | 未接入 |
| 省级电力零售规则 | Taxonomy 完成；字段存储待建 | 未接入 | 复用公开地区；专题 API 待建 | 完成空态矩阵 | Taxonomy/31省测试 | 未接入 |
